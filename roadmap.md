...
- [ ] Maestro `pdf-back` secondary flow is a no-op today (taps index 0, looks for `.pdf` text) — rewrite against a real PDF lesson of the E2E course; keep non-blocking until it passes twice

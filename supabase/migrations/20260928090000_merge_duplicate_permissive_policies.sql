BEGIN;
DROP POLICY IF EXISTS "Admins can view all testimonials" ON public.landing_testimonials;
...
DROP POLICY IF EXISTS "Teachers update assigned doubt sessions" ON public.doubt_sessions;
DROP POLICY IF EXISTS "Teachers view assigned doubt sessions" ON public.doubt_sessions;
...
DROP POLICY IF EXISTS "Users can update own participation" ON public.live_participants;
DROP POLICY IF EXISTS "Users can view own participation" ON public.live_participants;
...
DROP POLICY IF EXISTS hero_select_active_public ON public.hero;
DROP POLICY IF EXISTS hero_select_all_admin ON public.hero;
DROP POLICY IF EXISTS social_links_select_active_public ON public.social_links;
DROP POLICY IF EXISTS social_links_select_all_admin ON public.social_links;
...
DROP POLICY IF EXISTS "Admins can view all landing courses" ON public.landing_courses;

...
- 2026-07-08 — [Sprint 3.5 ship + frog-eye](./2026-07-08-sprint3.5-ship.md) — g_shared/cors.ts` on 3 payment/admin fns, 4 new LOW findings, reusable audit prompt.
...
- [2026-09-16 PDF fix + E2E + CI/CD pipeline](./2026-09-16-pdf-fix-e2e-ci.md) — rendering 4→9 via Tailwind escape fix, E2E selector suite rewritten, PLAY_SERVICE_ACCOUNT_JSON invalid (pre-check skips), build 35098611829 green + Drive verified; E2E run 35098599062 still failing (logs zip unrelayable via gateway).
- [2026-09-17 Session loose ends (observer)](./2026-09-17-session-loose-ends.md) — Ask-a-Doubt CORS still stale in prod (verified live 04:05 UTC), 9-step fix plan 0/9 applied, 3 CRITICAL approval dropped mid-thread; 3 retracted claims listed as do-not-resurrect.
